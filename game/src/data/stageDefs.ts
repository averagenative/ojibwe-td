...
export const ALL_STAGES: StageDef[] = [
  ...
  },
  {
    ...
    description:     'A hook-shaped path through scorched savanna. The inner clearing offers devastating crossfire positions.',
    waveCount:       20,
    pathFile:        'map-06',
    difficulty:      4,
    towerAffinities: ['rock-hurler', 'aura', 'frost'],
    unlockId:        'unlock-stage-mitigomizh-02',
    unlockCost:      600,
    creepRoster:     ['grunt', 'runner', 'brute', 'swarm', 'scout', 'flier'],
  },
  {
    ...
    regionId:        'mitigomizh',
    name:            'Burnt Ridge',
    description:     'Creeps descend from the ridge and sweep the charred lowlands. Control the vertical drop and the long bottom stretch.',
    waveCount:       20,
    pathFile:        'map-07',
    difficulty:      5,
    towerAffinities: ['tesla', 'poison', 'rock-hurler'],
    unlockId:        'unlock-stage-mitigomizh-03',
    unlockCost:      750,
    creepRoster:     ['grunt', 'runner', 'brute', 'swarm', 'scout', 'flier'],
  },
  {
...
export const ALL_REGIONS: RegionDef[] = [
  ...
  },
  {
    ...
    stages:        ['mitigomizh-01', 'mitigomizh-02', 'mitigomizh-03'],
