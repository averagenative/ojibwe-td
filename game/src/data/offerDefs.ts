...
export const ALL_OFFERS: OfferDef[] = [
  ...
  },
  {
    ...
    weight:          7,
    rarity:          'common',
    synergyRequires: ['rock-hurler', 'poison'],
  },
  {
    id:              'cryo-cannon',
    name:            'Cryo Cannon',
    ...
    weight:          7,
    rarity:          'common',
    synergyRequires: ['rock-hurler', 'frost'],
  },
  {
    id:              'grounded',
    name:            'Grounded',
  ...
  // Synergy (4)
  {
    ...
    // Note: tesla=air, poison=ground — canSynergize returns false, so this offer
    // is automatically excluded from the draw pool by the synergyCompatible filter.
  },
  {
    id:              'concussion-shell',
